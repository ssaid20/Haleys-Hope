...
const AssessmentResults = () => {
    const olderAssessment = useSelector((store) => store.assessmentReducer.olderAssessment);
    const youngerAssessment = useSelector((store) => store.assessmentReducer.youngerAssessment)
